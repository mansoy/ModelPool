...
//
//
function TComm.WriteCommData( pDataToWrite: PAnsiChar; dwSizeofDataToWrite: Word ): Boolean;
var
   Buffer: Pointer;
begin
...
begin
     ...
     OutputDebugString(PWideChar(Format('%.8X', [dcb.Flags])));
     ...
     OutputDebugString(PWideChar(Format('%d %d %d', [dcb.ByteSize, dcb.Parity, dcb.StopBits])));
...
procedure TReadThread.Execute;
var
   szInputBuffer: array[0..INPUTBUFFERSIZE-1] of AnsiChar;
